...
<%@ include file="../common/head.jspf"%>
 ...
 <form action="find_pw.kh" method="post">
        ...
        <!-- 이름(영문) 입력창 -->
        <div class="row center m20"> 
            <input type="text" name="memberFname" required placeholder="이름 입력"  class="underline fill" autocomplete="off">
        </div>
       
        
        <!-- 이메일 입력창 -->
        <div class="row center m20"> 
            <input type="text" name="memberEmail" required placeholder="이메일 입력"  class="underline fill" autocomplete="off">
        </div>
        
        <!-- 핸드폰 입력창 -->
        <div class="row center m20"> 
            <input type="tel" name="memberPhone" required placeholder="전화번호 입력"  class="underline fill" autocomplete="off">
        </div>
