...
<div class="row center">
	<h1 class="title-text">TGIF에 오신 것을 환영합니다</h1>
</div>
<div class="row center">
...
TGIF를 이용해 주셔서 감사합니다. 
이 약관은 TGIF㈜(이하, “회사”)가 운영하는 온라인 인터넷 사이트 및 애플리케이션(이하, “홈페이지”)에서 제공하는
...
TGIF㈜는 온라인 회원 가입과 관련하여 아래와 같은 개인정보를 수집 및 이용하고 있습니다 .
개인정보처리에 대한 상세한 사항은 TGIF㈜ 홈페이지의 “개인정보 처리방침”을 참조하세요.
“개인정보 처리방침”과 이 개인정보 수집 및 이용 동의서의 내용과 상충되는 사항이 있는 경우에는 이 동의서의 내용이 우선합니다.
       ...
       <div>
					...
					<ul>
                        ...
                        <div class="row center">
                        <textarea name="" id="" class="form-input fill input-round" rows="7">
TGIF㈜는 개인위치정보를 이용하여 서비스를 제공하고자 하는 경우에는 회원이 본 약관에 동의하면 위치정보 이용에 동의한 것으로 간주됩니다.
회원이 제공한 개인위치정보를 해당 회원의 동의 없이 서비스 제공 이외의 목적으로 이용하지 않습니다. 단, 고객이 미리 요청한 경우 해당 내용을 고객이 지정한 휴대전화나 이메일 주소로 통보할 수 있습니다.
				...
				<li>
					<ul>
                        ...
                        <textarea name="" id="" class="form-input fill input-round" rows="7">
TGIF㈜의 온라인 회원 서비스 관련 정보, 혜택, 신상품 안내, 이벤트 및 맞춤 서비스 정보 수신을 위해
